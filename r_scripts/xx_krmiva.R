...
data <- read_excel("./Polozky_PR/Krmiva 2022.xlsx", sheet=2, guess_max=21474836)
...
newdata = "2022-01-01 00:00:00 CET"
...
###################################
pngfile = paste("krmiva_cs137.png",sep="")
...
text(newoldcs$od[outliers[i]],newoldcs$a[outliers[i]]+3,outind[i])  
text(leftalign,60-3*i,outlabels[i], pos = 4)  
}
