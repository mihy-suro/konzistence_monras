...
data <- read_excel("./Polozky_PR/Seno a senáž 2023.xlsx", sheet=2, guess_max=21474836)
...
statscs<-paste("Seno, senáž: Cs-137 D-statistika = ",signif(as.numeric(kscs[1]),4),";  p-hodnota = ",signif(as.numeric(kscs[2]),4)) 
...
###################################
pngfile = paste("seno_senaz_cs137.png",sep="")
...
for(i in 1:length(outliers)){
  ...
  text(leftalign,30-3*i,outlabels[i], pos = 4)  
}
