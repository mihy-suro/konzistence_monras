...
#==============================================================================
# Boxplot mléko konzumní - pouze SÚRO
#==============================================================================
...
statscs<-paste("Mléko konzumní (SÚRO) - Cs-137 D-statistika = ",signif(as.numeric(kscs[1]),4),";  p-hodnota = ",signif(as.numeric(kscs[2]),4)) 
...
statssr<-paste("Mléko konzumní (SÚRO) - Sr-90 D-statistika = ",signif(as.numeric(kssr[1]),4),";  p-hodnota = ",signif(as.numeric(kssr[2]),4))
...
###################################
pngfile = paste("mleko_konzumni_boxplot.png",sep="")
...
#==============================================================================
# QQPLOT mléko konzumni (pouze SURO)
#==============================================================================
pngfile = paste("mleko_konzumni_qqplot_Cs137.png",sep="")
...
mtext("Konzumní mléko - Cs-137", side=3, line=0, cex=2)
dev.off()


pngfile = paste("mleko_konzumni_qqplot_Sr90.png",sep="")
png(filename=pngfile,width = 1100, height = 700, units = "px")
...
limits <- paste("Mléko konzumní Cs-137:  Prùmìr = ", signif(mean(newoldcs$a),3),";  TI90 = ",signif(ti90[5],3),";  TI95 = ",signif(ti95[5],3), ";  TI99 = ",signif(ti99[5],3),sep="")
...
pngfile = paste("mleko_konzumni_casovarada_cs137.png",sep="")
png(filename=pngfile,width = 1100, height = 700, units = "px")
...
limits <- paste("Mléko konzumní Sr-90:  Prùmìr = ", signif(mean(newoldsr$a),3),";  TI90 = ",signif(ti90[5],3),";  TI95 = ",signif(ti95[5],3), ";  TI99 = ",signif(ti99[5],3),sep="")
outliers<-which(newoldsr$a>as.numeric(ti99[5]))
outind<-c(1:length(outliers))
outlabels<-paste(outind, " ... " ,newoldsr$kom[outliers],"/",newoldsr$om[outliers])

pngfile = paste("mleko_konzumni_casovarada_sr90.png",sep="")
png(filename=pngfile,width = 1100, height = 700, units = "px")
